...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            return redirect()->route('customer.index')->with('success','تم الإنشاء بنجاح');
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($customer){
            ...
            if($status){
                return redirect()->route('customer.index')->with('success','تم التعديل بنجاح');
            }else{
                return back()->with('error','هناك خطأ ما !!');
            }
        }else{
    ...
    public function destroy($id)
    {
        ...
        if($status){
            return redirect()->route('customer.index')->with('success','تم الحذف بنجاح');
        }else{
