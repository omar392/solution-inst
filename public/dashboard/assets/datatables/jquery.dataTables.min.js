...
(function(h) {
    ...
    function Fa(a) {
        var b = m.defaults.oLanguage,
            c = a.sZeroRecords;
        !a.sEmptyTable && (c && "لا  يوجد بيانات متاحة فى الجدول" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="ب" class="' + b.sFilterInput + '"/>',
            j = d.sSearch,
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "First", sLast: "Last", sNext: "السابق", sPrevious: "القادم" },
            sEmptyTable: "لا  يوجد بيانات متاحة فى الجدول",
            sInfo: "اظهار _START_ من _END_ الى _TOTAL_ العناصر",
            sInfoEmpty: "اظهار 0 من 0 الى 0 عنصر",
