                ...
                <div class="row align-items-center">
                    <div class="text-center">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                            data-target=".bs-example-modal-lg"><i class="fas fa-plus-circle"></i>إضافة عميل جديد</button>
                    </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title mt-0" id="myLargeModalLabel" style="font-family: cairo;">إضافة عميل جديد</h5>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="name_ar"
                                                        id="example-text-input" placeholder="إسم العميل" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="name_en"
                                                        id="example-text-input" placeholder="Customer Name" required>
                                                </div>
                                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($customer as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->name_ar }}</td>
                                                <td>{{ $item->name_en }}</td>
                                                <td><img src="{{ !empty($item->image) ? url('upload/customer/' . $item->image) : url('upload/no_image.jfif') }}"
                                                ...
                                                <td>
                                                    <a href="{{ route('customer.edit', $item->id) }}"><button type="button"
