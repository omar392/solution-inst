                            ...
                            <form action="{{route('advert.update',$advert->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">عنوان الاعلان</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="title_ar"
                                            id="example-text-input" placeholder="عنوان الاعلان" value="{{$advert->title_ar}}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="title_en"
                                            id="example-text-input" placeholder="Advert Title" value="{{$advert->title_en}}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">الاعلان</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description_ar" id="editor5">{!! $advert->description_ar !!}</textarea>
                                    <script>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Advert</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="description_en" id="editor">{!! $advert->description_en !!}</textarea>
                                        <script>
