                ...
                <div class="row align-items-center">
                    <div class="text-center">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                            data-target=".bs-example-modal-lg"><i class="fas fa-plus-circle"></i>إضافة اعلان جديد</button>
                    </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title mt-0" id="myLargeModalLabel" style="font-family: cairo;">إضافة اعلان جديد</h5>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="title_ar"
                                                        id="example-text-input" placeholder="عنوان الاعلان" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="title_en"
                                                        id="example-text-input" placeholder="Advert Title" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input"
                                    ...
                                    <tbody>
                                        @foreach ($advert as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->title_ar }}</td>
                                                <td>{{ $item->title_en }}</td>
                                                <td><img src="{{ !empty($item->image) ? url('upload/advert/' . $item->image) : url('upload/no_image.jfif') }}"
