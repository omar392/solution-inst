                                    ...
                                    <tbody>
                                        @foreach ($gallary as $item)
                                            <tr>
                                                ...
                                                <td><img src="{{ !empty($item->image) ? url('upload/gallary/' . $item->image) : url('upload/no_image.jfif') }}"
                                                ...
                                                <td>
                                                    <a href="{{ route('gallary.edit', $item->id) }}"><button type="button"
                                                            class="float-left btn btn-info" data-size="sm" title="Edit"><i
                                                                class="fa fa-edit"></i></button></a>
                                                    &ensp;
                                                    <form class="float-left ml-1"
                                                        action="{{ route('gallary.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
